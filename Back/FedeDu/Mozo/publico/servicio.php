<?php
require_once '../lib/mesaModel.php';
$mozo = new MesaModel;
$mesas = $mozo->obtenerMesas();
?>
...
<html lang="en">
  ...
  <body data-bs-theme="dark">
    ...
    <div class="container">
        ...
        <?php
        $chunked_mesas = array_chunk($mesas, 2); // dividir las mesas en grupos de 3
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                                ...
                                if ($mesa['estado_mesa']==5) { ?>  
                                    <a href="#" class="btn btn-info bg-gradient h-100 w-100 mesa">
                                    <h5 class="card-title border border-1 bg-danger-subtle bg-gradient blanco" ><?php echo $mesa['id']; ?></h5>
                                    <p class="card-text ">Requiere Servicio</p> <?php
                                } elseif ($mesa['estado_mesa']==1) {
                                    ?>  
